 ...
 * @author hungt
 */
@WebServlet(name = "CodeVeriForgot", urlPatterns = {"/codeveriforgot"})
public class CodeVeriForgot extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (code.equals(codeRandom)) {
            request.setAttribute("sendCodeForgotSuccess", "sendCodeForgotSuccess");
            processRequest(request, response);
        } else {
            request.setAttribute("errorSendCode", "Code khong dung. Vui long nhap lai!");
            processRequest(request, response);
        }
    }
